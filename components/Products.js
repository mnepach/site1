    ...
    const products = [
      {
        ...
        price: 24.99,
        image: "https://images.unsplash.com/photo-1721117839465-604a3c54ceb3?auto=format&fit=crop&w=600&q=80",
      ...
      },
      {
        ...
        price: 29.99,
        image: "https://images.unsplash.com/photo-1622576454339-3cf6e5e9d44a?auto=format&fit=crop&w=600&q=80",
        features: ["Устойчив к болезням", "Сладкие плоды", "Декоративный вид"]
      },
      {
        name: "Малина ремонтантная",
        price: 19.99,
        image: "https://images.unsplash.com/photo-1593461802389-d57d73a36913?auto=format&fit=crop&w=600&q=80",
